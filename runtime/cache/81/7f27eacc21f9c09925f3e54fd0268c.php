<?php
//000000000000s:33339:"<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>商品详情</title>
		...
		<div class="inner_sec">
			<div class="section_left">
				<div class="pic">
					<div id="marquee">
						<ul>
															<li class="jqzoom"><img id="zoomimg" src="/public/images/icon_goods_thumb_empty_300.png" jqimg="/public/images/icon_goods_thumb_empty_300.png" width="425" height="425" /></li>
															<li class="jqzoom"><img id="zoomimg" src="/public/images/icon_goods_thumb_empty_300.png" jqimg="/public/images/icon_goods_thumb_empty_300.png" width="425" height="425" /></li>
															<li class="jqzoom"><img id="zoomimg" src="/public/images/icon_goods_thumb_empty_300.png" jqimg="/public/images/icon_goods_thumb_empty_300.png" width="425" height="425" /></li>
													</ul>
					</div>
					<div id="marqueeNav">
						<ul>
															<li><img src="/public/images/icon_goods_thumb_empty_300.png" width="80" height="80" /></li>
															<li><img src="/public/images/icon_goods_thumb_empty_300.png" width="80" height="80" /></li>
															<li><img src="/public/images/icon_goods_thumb_empty_300.png" width="80" height="80" /></li>
													</ul>
					</div>
				...
				<div class="detail-ggsl">
					<form id="buy_goods_form" name="buy_goods_form" method="post" >
						...
						<div class="price">
								...
								<div class="pri_send">
									<span class="pri_l">商城价：</span><span class="pri_r" id="goods_price">￥10.00</span>
								</div>
						...
						<div class="content">
							...
							<div class="cont_sl">
								<div><h5>数量</h5></div>
								<input class="cont_cho" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" onkeyup="this.value=this.value.replace(/[^\d]/g, '')" max="970" />
								<div class="cont_bnt">
								...
								<div class="cont_txt">
									<p>件</p>
									<p>库存<span id="store_count">969</span>件</p>
								</div>
							</div>
						</div>
						<div class="bnt_shop">
							<input type="hidden" name="goods_id" value="20" />
															<a class="bnt bnt_shop_l" href="javascript:;" onclick="AjaxAddCart(20,1,1);">立即购买</a>
								<a class="bnt bnt_shop_r" href="javascript:;" onclick="AjaxAddCart(20,1,0);"><i class="glyphicon glyphicon-shopping-cart"></i> 加入购物车</a>
													</div>
						<div class="promise">
						...
						<div class="share">
							...
							<script>
								var jiathis_config = {
									url:"http://tests.91tfs.com/index.php?m=Home&c=Goods&a=goodsInfo&id=20",
							...
							<a href="javascript:void(0);" id="collectLink">收藏商品（33人气）</a>
						</div>
					</form>
				</div>
				<div class="clearfix"></div>
				...
				<div class="sec_two_main">
					<div class="introduceshop">
						...
						<div class="cont" id="new1">
							<div class="cont_one">
								<h6>产品名称：饱润肽冰爽夏日喷雾</h6>

								<div class="cont_txet">
									<ul>
																					<li ><span>产品规格：</span><span>120g</span></li>
																					<li style="width:100%"><span>成分：</span><span>小分子羊胎盘肽-水解胎盘（羊）提取物、马齿苋（PORTULACA OLERACEA）提取物、粉防己（STEPHANIA TETRANDRA）提取物，红没药醇、二氧化钛</span></li>
																					<li ><span>产地：</span><span>广州</span></li>
																					<li style="width:100%"><span>功效：</span><span>保持肌肤水分，有效反射光线，防止肌肤晒伤晒黑。舒缓肌肤，让肌肤自由享受日光浴。</span></li>
																					<li ><span>化妆品品类：</span><span>喷雾系列</span></li>
																			</ul>
								</div>
							</div>
							<div class="cont_detail">
								<p style="text-align: center;"><img src="/public/upload/temp/2017/09-26/8548e206775e7b0ca6f35876c30dcd7f.jpg" title="8548e206775e7b0ca6f35876c30dcd7f.jpg" alt="8548e206775e7b0ca6f35876c30dcd7f.jpg"/></p>							</div>
						</div>
...
<div class="hidden" id="look_see">
			...
			<div class="otherpic_one">
			<div>
				<a href="/Home/Goods/goodsInfo/id/8.html"><img src="/public/upload/goods/thumb/8/goods_thumb_8_150_150.jpeg" width="150" height="150"/></a>
			</div>
			<div class="text-center"><a href="/Home/Goods/goodsInfo/id/8.html">饱润肽丝滑精粹原液</a></div>
			<p>￥238.00</p>
		</div>
			<div class="otherpic_one">
			<div>
...
<script type="text/javascript">
	...
	function ajaxComment(commentType, page) {
		$.ajax({
			type: "GET",
			url: "/index.php?m=Home&c=goods&a=ajaxComment&goods_id=20&commentType=" + commentType + "&p=" + page,//+tab,
			success: function (data) {
