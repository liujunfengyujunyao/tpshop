<?php
//000000000000s:70552:"<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>商品列表</title>
...
<div class="search-box p">
	<div class="w1430">
		<div class="search-path fl">
			<a href="/index.php/Home/Goods/goodsList/id/4.html">全部商品</a>
			<i class="litt-xyb"></i>
			...
			<!--如果当前分类是三级分类 则二级也要显示-->
						<!--如果当前分类是三级分类 则二级也要显示-->
							<div class="havedox">
					<div class="disenk"><span>清洁系列</span><i class="litt-xxd"></i></div>
					<div class="hovshz">
						<ul>
			...
			<span><a href="/index.php/Home/Goods/goodsList/id/4.html">清空筛选条件</a></span>
		</div>
	</div>
</div>
<!-- 筛选 start -->
                        ...
                        <div class="lf-list">
                            <div class="brand-box brand-list">
                                <div class="clearfix p">
                                                                            <a href="/index.php/home/Goods/goodsList/id/4/brand_id/1" data-href="/index.php/home/Goods/goodsList/id/4/brand_id/1"  data-key='brand' data-val='1'>
                                            <i class="litt-zd"></i>
                    ...
                    <dd class="ri-section">
                        <div class="lf-list">
                            <div class="brand-list">
                                <div class="clearfix p">
                                                                            <a href="/index.php/home/Goods/goodsList/id/4/attr/5_清洁系列" data-href="/index.php/home/Goods/goodsList/id/4/attr/5_清洁系列" data-val='清洁系列' data-key='5'>
            ...
            <!-- 价格筛选 start -->
                    ...
                    <dd class="ri-section">
                        <div class="lf-list">
                            <div class="brand-list">
                                <div class="clearfix p">
                                                                            <a href="/index.php/home/Goods/goodsList/id/4/price/72-90">
                                            <span>72-90元</span>
                                        </a>
                                                                    </div>
                            </div>
                        ...
                        <div class="lr-more">
                            ...
                            <!--填写筛选价格区间-s-->
                            <form action="/index.php/Home/Goods/goodsList/id/4" method="post" id="price_form">
		...
		<div class="stsho fr">
			<div class="sx_topb ba-dark-bg">
				<div class="f-sort fl">
					<ul>
						<li class="red">
                            <a href="/index.php/Home/Goods/goodsList/id/4">综合</a>
                        </li>
						<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/4/sort/sales_sum">销量</a>
                        </li>
													<li class="">
                                <a href="/index.php/Home/Goods/goodsList/id/4/sort/shop_price/sort_asc/desc">价格<i class="litt-zzx1"></i></a>
                            </li>
												<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/4/sort/comment_count">评论</a>
                        </li>
						<li class="">
                            <a href="/index.php/Home/Goods/goodsList/id/4/sort/is_new">新品</a>
                        </li>
					</ul>
				</div>
