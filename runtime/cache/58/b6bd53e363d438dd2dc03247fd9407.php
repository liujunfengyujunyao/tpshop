<?php
//000000000000s:80850:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
...
<div id="shortcut">
	<div class="w">
		<ul class="fr">
			...
			<li class="spacer"></li>
			<li class="fore4">
				<div class="dt"><a href="/index.php/Home/User/goods_collect.html">我的优惠券</a></div>
			</li>
			<li class="spacer"></li>
			<li class="fore5">
...
<div class="details-bigimg p">
    <div class="w1224">
            ...
            <div class="product-gallery">
                <div class="product-photo" id="photoBody">
                    ...
                    <div class="product-img jqzoom">
                        <img id="zoomimg" src="/public/upload/goods/thumb/2/goods_thumb_2_400_400.png" jqimg="/public/upload/goods/thumb/2/goods_thumb_2_800_800.png">
                    </div>
                    <!-- 商品大图介绍 end ]]-->
                    <!-- 商品小图介绍 start [[-->
                    <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                        <div class="pic-hide-box fl">
                            <ul class="small-pic" style="left:0;">
                                    ...
                                    <a href="javascript:;">
                                        <img src="/public/upload/goods/thumb/2/goods_sub_thumb_3_60_60.png" data-img="/public/upload/goods/thumb/2/goods_sub_thumb_3_400_400.png" data-big="/public/upload/goods/thumb/2/goods_sub_thumb_3_800_800.png">
                                        <i></i>
                                    </a>
                                    </li>
                                                            </ul>
                ...
                <div class="share">
                    ...
                    <script>
                        var jiathis_config = {
                            url:"http://tests.91tfs.com/index.php?m=Home&c=Goods&a=goodsInfo&id=2",
                            pic:"http://tests.91tfs.com/public/upload/goods/thumb/2/goods_thumb_2_400_400.png",
                        }
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" >
            ...
            <input type="hidden" name="shop_price" value="198.00"/><!-- 活动价格 -->
            <input type="hidden" name="store_count" value="967"/><!-- 活动库存 -->
                    ...
                    <div class="shop-price-le">
                        ...
                        <ul id="activity_title_div" style="display: none">
                            ...
                            <li><span id="activity_title" style="color: #df3033;background: 0 0;border: 1px solid #df3033;padding: 2px 3px;"></span></li>
                                ...
                                <li><span class="fullminus">10</span></li>
                            </ul>
                                            </div>
                    <div class="shop-cou-ri">
                        <div class="allcomm"><p>累计评价</p><p class="f_blue">3</p></div>
                        <div class="br1"></div>
                        <div class="allcomm"><p>累计销量</p><p class="f_blue">2</p></div>
                    </div>
                </div>
                ...
                <div class="standard">
                    <ul class="p">
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">库存：<span id="spec_store_count">967</span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="2" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(2,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(2,1,0);"><i class="sk"></i>加入购物车</a>
            ...
            <div class="introduceshop">
                ...
                <div class="shop-describe shop-con-describe p">
                    <div class="deta-descri">
                        <p class="shopname_de"><span>商品名称：</span><span>饱润肽焕颜气垫CC霜（象牙白）</span></p>
                        <div class="ma-d-uli p">
                            <ul>
                                <!--<li><span>品牌：</span><span>肽风尚</span></li>-->
                                <li><span>货号：</span><span>TP0000002</span></li>
                                                                    ...
                                                                    <li><span>功效：</span><span>与美白成分烟酰胺共同作用，清除肌肤自由基，抑制黑色素分泌，有效嫩白肌肤，实现内外兼修</span></li>
                    ...
                    <div class="detail-img-b">
                        <p style="text-align: center;"><img src="/public/upload/temp/2017/09-20/54c5b1ce752acb63c699104937b12ff5.jpg" title="54c5b1ce752acb63c699104937b12ff5.jpg" alt="54c5b1ce752acb63c699104937b12ff5.jpg"/></p>                    </div>
                </div>
                    ...
                    <div class="deta-descri">
                        ...
                        <h2 class="shopname_de">属性</h2>
                                ...
                                <p>广州</p>
                                                    ...
                                                    <div class="twic_a_alon">
                                <p class="gray_t">功效</p>
                                <p>与美白成分烟酰胺共同作用，清除肌肤自由基，抑制黑色素分泌，有效嫩白肌肤，实现内外兼修</p>
                            </div>
                                                    <div class="twic_a_alon">
                    ...
                    <div class="consult-h" id="consult-h">
                        ...
                        <div class="consult-cont">
                            <div class="consult-item">
                                ...
                                <form method="post" id="consultForm" action="/index.php/home/Goods/goodsConsult.html">
                                    <input type="hidden" name="goods_id" value="2"/>
...
<div style="display: none" id="look_see">
            ...
            <div class="alone-shop">
                ...
                <p class="price-tag">
                    <span class="li_xfo">￥</span><span>0.01</span>
                </p>
            </div>
        </div>
        <!--看了又看-s-->
...
<script type="text/javascript">
    ...
    function initGoodsPrice() {
        ...
        $.ajax({
            ...
            url: "/index.php/Home/Goods/activity.html",
            success: function (data) {
                if (data.status == 1) {
    ...
    function ajaxComment(commentType,page){
        $.ajax({
            type : "GET",
            url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=2&commentType="+commentType+"&p="+page,//+tab,
            success: function(data){
