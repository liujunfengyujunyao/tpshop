<?php
//000000000000s:79871:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
...
<div class="details-bigimg p">
    <div class="w1224">
        <div class="detail-img">
            <div class="product-gallery">
                ...
                <div class="share">
                    ...
                    <script>
                        var jiathis_config = {
                            url:"http://tests.91tfs.com/index.php?m=Home&c=Goods&a=goodsInfo&id=19",
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" >
            ...
            <input type="hidden" name="shop_price" value="168.00"/><!-- 活动价格 -->
            <input type="hidden" name="store_count" value="899"/><!-- 活动库存 -->
                ...
                <div class="standard">
                    <ul class="p">
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">库存：<span id="spec_store_count">899</span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="19" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(19,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(19,1,0);"><i class="sk"></i>加入购物车</a>
            ...
            <div class="introduceshop">
                ...
                <div class="shop-describe shop-con-describe p">
                    <div class="deta-descri">
                        <p class="shopname_de"><span>商品名称：</span><span>饱润肽雪肌焕彩素颜霜</span></p>
                        <div class="ma-d-uli p">
                            <ul>
                                <!--<li><span>品牌：</span><span>肽风尚</span></li>-->
                                <li><span>货号：</span><span>TP0000019</span></li>
                                                                    <li><span>产品规格：</span><span>50g</span></li>
                                                                    <li><span>成分：</span><span>小分子羊胎盘肽-水解胎盘（羊）提取物、甜菜碱、二氧化钛</span></li>
                                                                    <li><span>功效：</span><span>告别黯沉，美白肌肤，自然柔润，呈现素雅匀净肤色。</span></li>
                    ...
                    <div class="detail-img-b">
                        <p style="text-align: center;"><img src="/public/upload/temp/2017/09-26/dccaee9b05434f1f9c043274d3c49f43.jpg" title="dccaee9b05434f1f9c043274d3c49f43.jpg" alt="dccaee9b05434f1f9c043274d3c49f43.jpg"/></p>                    </div>
                </div>
                    ...
                    <div class="deta-descri">
                        ...
                        <h2 class="shopname_de">属性</h2>
                                ...
                                <p>50g</p>
                                                    ...
                                                    <div class="twic_a_alon">
                                <p class="gray_t">成分</p>
                                <p>小分子羊胎盘肽-水解胎盘（羊）提取物、甜菜碱、二氧化钛</p>
                            </div>
                                                    <div class="twic_a_alon">
                                <p class="gray_t">功效</p>
                                <p>告别黯沉，美白肌肤，自然柔润，呈现素雅匀净肤色。</p>
                            </div>
                                                    <div class="twic_a_alon">
                                <p class="gray_t">产地</p>
                                <p>广州</p>
                ...
                <div class="shop-con-describe p" style="display: none;">
                    <div class="shop-describe p">
                        ...
                        <div class="deta-descri p">
                            <ul class="tebj">
                                <li class="percen"><span>0%</span></li>
                                <li class="co-cen">
                        ...
                        <div class="deta-descri p">
                            <div class="cte-deta">
                                <ul id="fy-comment-list">
                                    ...
                                    <li data-t="4">
                                        <a href="javascript:void(0);">差评（1）</a>
                                    </li>
                                    <li data-t="5">
...
<div style="display: none" id="look_see">
            ...
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/16.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/16.html">饱润肽雪肌精华乳</a>
                </p>
                <p class="price-tag">
            ...
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/8.html"><img class="wiahides" src="/public/upload/goods/thumb/8/goods_thumb_8_206_206.jpeg" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/8.html">饱润肽丝滑精粹原液</a>
                </p>
                <p class="price-tag">
            ...
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/20.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/20.html">饱润肽冰爽夏日喷雾</a>
                </p>
                <p class="price-tag">
...
<script type="text/javascript">
    ...
    function ajaxComment(commentType,page){
        $.ajax({
            type : "GET",
            url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=19&commentType="+commentType+"&p="+page,//+tab,
            success: function(data){
