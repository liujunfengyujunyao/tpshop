<?php
//000000000000s:15218:"<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>商品列表</title>
        ...
        <div class="container">
            <div class="row volume">
                <div class="col-xs-10">
                    <ul>
                        <li>
                            <a href="/index.php/Home/Goods/goodsList/id/2" >综合</a>
                        </li>
                        <li>
                            <a href="/index.php/Home/Goods/goodsList/id/2/sort/sales_sum" class="current">销量</a>
                        </li>
                                                    <li>
