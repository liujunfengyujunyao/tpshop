<?php
//000000000000s:76544:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
...
<div class="search-box p">
    <div class="w1224">
        <div class="search-path fl">
                            <a href="/Home/Goods/goodsList/id/6.html">肽风尚美人柜</a>
                <i class="litt-xyb"></i>
                        <div class="havedox">
                <span>B套餐-美人柜</span>
            </div>
...
<div class="details-bigimg p">
    <div class="w1224">
        <div class="detail-img">
            <div class="product-gallery">
                ...
                <div class="share">
                    ...
                    <script>
                        var jiathis_config = {
                            url:"http://tests.91tfs.com/index.php?m=Home&c=Goods&a=goodsInfo&id=9",
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" >
            ...
            <input type="hidden" name="shop_price" value="1200.00"/><!-- 活动价格 -->
            <input type="hidden" name="store_count" value="997"/><!-- 活动库存 -->
                ...
                <div class="standard">
                    <ul class="p">
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">库存：<span id="spec_store_count">997</span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="9" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(9,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(9,1,0);"><i class="sk"></i>加入购物车</a>
            ...
            <div class="introduceshop">
                ...
                <div class="shop-describe shop-con-describe p">
                    <div class="deta-descri">
                        <p class="shopname_de"><span>商品名称：</span><span>B套餐-美人柜</span></p>
                        <div class="ma-d-uli p">
                            <ul>
                                <!--<li><span>品牌：</span><span></span></li>-->
                                <li><span>货号：</span><span>TP0000009</span></li>
                                                            </ul>
                        </div>
...
<div style="display: none" id="look_see">
            ...
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/6.html"><img class="wiahides" src="/public/upload/goods/thumb/6/goods_thumb_6_206_206.png" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/6.html">饱润肽隔离BB霜（自然色）</a>
                </p>
                <p class="price-tag">
                    <span class="li_xfo">￥</span><span>98.00</span>
                </p>
            </div>
        </div>
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/15.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/15.html">饱润肽隔离BB霜（象牙白）</a>
                </p>
                <p class="price-tag">
                    <span class="li_xfo">￥</span><span>128.00</span>
                </p>
            </div>
        </div>
            <div class="tjhot-shoplist type-bot">
            <div class="alone-shop">
                <a href="/Home/Goods/goodsInfo/id/19.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
                <p class="shop_name2">
                    <a href="/Home/Goods/goodsInfo/id/19.html">饱润肽雪肌焕彩素颜霜</a>
                </p>
                <p class="price-tag">
                    <span class="li_xfo">￥</span><span>168.00</span>
                </p>
            </div>
        </div>
        <!--看了又看-s-->
...
<script type="text/javascript">
    ...
    function ajaxComment(commentType,page){
        $.ajax({
            type : "GET",
            url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=9&commentType="+commentType+"&p="+page,//+tab,
            success: function(data){
