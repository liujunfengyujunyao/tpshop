<?php
//000000000000s:80388:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
...
<div class="details-bigimg p">
    <div class="w1224">
        <div class="detail-img">
            <div class="product-gallery">
                ...
                <div class="share">
                    ...
                    <script>
                        var jiathis_config = {
                            url:"http://tests.91tfs.com/index.php?m=Home&c=Goods&a=goodsInfo&id=18",
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" >
            ...
            <input type="hidden" name="shop_price" value="188.00"/><!-- 活动价格 -->
            <input type="hidden" name="store_count" value="964"/><!-- 活动库存 -->
            ...
            <input type="hidden" name="exchange_integral" value="100"/><!-- 积分 -->
                ...
                <div class="standard">
                    <ul class="p">
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">库存：<span id="spec_store_count">964</span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="18" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;"  onclick="buyIntegralGoods(18,1,1);">立即兑换</a>
            ...
            <div class="introduceshop">
                ...
                <div class="shop-describe shop-con-describe p">
                    <div class="deta-descri">
                        <p class="shopname_de"><span>商品名称：</span><span>饱润肽焕颜亮肤面膜</span></p>
                        <div class="ma-d-uli p">
                            <ul>
                                <!--<li><span>品牌：</span><span>肽风尚</span></li>-->
                                <li><span>货号：</span><span>TP0000018</span></li>
                                                                    <li><span>产品规格：</span><span>25g</span></li>
                                                                    <li><span>成分：</span><span>小分子羊胎盘肽-水解胎盘（羊）提取物、积雪草甙、透明质酸钠</span></li>
                                                                    <li><span>产地：</span><span>广州</span></li>
                                                                    <li><span>功效：</span><span>改善肤色暗沉，达到美白效果；能有效清除自由基，延缓皮肤衰老；使肌肤更莹润保湿、持续饱满丰弹，红润诱人。</span></li>
                                                            </ul>
                        </div>
                    ...
                    <div class="detail-img-b">
                        <p style="text-align: center;"><img src="/public/upload/temp/2017/09-26/82e970f0e1bc1d4a42113c37464253b0.jpg" title="82e970f0e1bc1d4a42113c37464253b0.jpg" alt="82e970f0e1bc1d4a42113c37464253b0.jpg"/></p>                    </div>
                </div>
                    ...
                    <div class="deta-descri">
                        ...
                        <h2 class="shopname_de">属性</h2>
                                ...
                                <p>25g</p>
                                                    ...
                                                    <div class="twic_a_alon">
                                <p class="gray_t">成分</p>
                                <p>小分子羊胎盘肽-水解胎盘（羊）提取物、积雪草甙、透明质酸钠</p>
                            </div>
                                                    <div class="twic_a_alon">
                                <p class="gray_t">产地</p>
                                <p>广州</p>
                                                    ...
                                                    <div class="twic_a_alon">
                                <p class="gray_t">功效</p>
                                <p>改善肤色暗沉，达到美白效果；能有效清除自由基，延缓皮肤衰老；使肌肤更莹润保湿、持续饱满丰弹，红润诱人。</p>
                            </div>
                                            </div>
                </div>
...
<script type="text/javascript">
    ...
    function ajaxComment(commentType,page){
        $.ajax({
            type : "GET",
            url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=18&commentType="+commentType+"&p="+page,//+tab,
            success: function(data){
