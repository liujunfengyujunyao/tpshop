<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"./template/pc/tfs/store\order_list.html";i:1519984570;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta name="keywords" content="<?php echo $tpshop_config['shop_info_store_keyword']; ?>" />
    <meta name="description" content="<?php echo $tpshop_config['shop_info_store_desc']; ?>" />
    <title>工厂店订单-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
                ...
                <div class="my_right">
                    <div class="per_main_r">
                        <ul class="list-inline order_title">
                                <li>
                                    <a href="<?php echo U('Store/order_list'); ?>" class="<?php if(\think\Request::instance()->param('type') == ''): ?>selected<?php endif; ?>"><span>全部订单</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Store/order_list',array('type'=>'WAITPAY')); ?>" class="<?php if(\think\Request::instance()->param('type') == 'WAITPAY'): ?>selected<?php endif; ?>"><span>待付款</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Store/order_list',array('type'=>'WAITSEND')); ?>" class="<?php if(\think\Request::instance()->param('type') == 'WAITSEND'): ?>selected<?php endif; ?>"><span>待发货</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Store/order_list',array('type'=>'WAITRECEIVE')); ?>" class="<?php if(\think\Request::instance()->param('type') == 'WAITRECEIVE'): ?>selected<?php endif; ?>""><span>待收货</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Store/order_list',array('type'=>'FINISH')); ?>" class="<?php if(\think\Request::instance()->param('type') == 'FINISH'): ?>selected<?php endif; ?>""><span>已完成</span></a>
                                </li>
                                <li><a href="<?php echo U('Store/return_goods_list'); ?>"><span>退货</span></a></li>
                            </ul>

                        <div class="good_back">
                            <div class="pull-left">
                                <form id="search_order" action="<?php echo U('Store/order_list'); ?>" method="post">
                                    <ul>
                                        <li>
                                            <label>订单编号:</label>
                            ...
                            <h4 class="pull-right">收益总金额：<a href="<?php echo U('Store/rebate_log'); ?>" class="style-red"><b>￥<?php echo $moneys; ?></b></a></h4>
                        </div>
                                    ...
                                    <div class="goods_list">
                                        <table class="table order_list_goods">
                                            <tr class="active">
                                                <td colspan="5">
                                                    <div class="pull-left">
														<span>订单编号：<a href="<?php echo U('Store/order_detail',array('id'=>$list['order_id'])); ?>"><?php echo $list['order_sn']; ?></a></span>
                                                        <span>下单时间：<?php echo date('Y-m-d H:i:s',$list['add_time']); ?></span>
                                                        <?php if($list['order_status'] != 0 && $list['order_status'] != 3 && $list['order_status'] != 5): ?>
                                                            <span>获利统计：<?php if($list['income'] == ''): ?>等待分成<?php else: ?><em class="style-red">￥<?php echo $list['income']; ?></em><?php endif; ?></span>
                                                        <?php endif; ?>
                                                    </div>

                                                    <div class="pull-right order-btn">
                                                        <?php if($list['order_status'] == 0 || $list['order_status'] == 1): if($list['pay_status'] == 1): if($list['shipping_status'] == 0): ?>
                                                                    <a href="javascript:void(0);" onClick="send_goods(<?php echo $list['order_id']; ?>)" class="style-red">发货</a>
                                                                <?php elseif($list['shipping_status'] == 1 && $list['shop_way'] == 2): ?>
                                                                    <a href="javascript:void(0);" onClick="confirm(<?php echo $list['order_id']; ?>)" class="btn btn-danger">确认收货</a>
                                                                <?php elseif($list['shipping_status'] == 1 && $list['shop_way'] == 3): ?>
                                                                    <a href="javascript:check_safecode(<?php echo $list['order_id']; ?>)" class="style-red">自提校验</a>
                                            ...
                                            <?php if(is_array($list['goods_list']) || $list['goods_list'] instanceof \think\Collection || $list['goods_list'] instanceof \think\Paginator): $k = 0; $__LIST__ = $list['goods_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($k % 2 );++$k;if($k == 1): ?>
                                                    <tr>
                                                        ...
                                                        <td width="15%" rowspan="<?php echo count($list['goods_list']); ?>" class="sx1">
                                                            ...
                                                            <p>
                                                                <a href="<?php echo U('Store/order_detail',array('id'=>$list['order_id'])); ?>">订单详情</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                <?php else: ?>
