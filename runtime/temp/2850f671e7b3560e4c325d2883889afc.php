			...
			<div class="col-md-10 col-sm-9 col-lg-10">
				...
				<div class="my_right">
					<div class="col-sm-12">
						...
						<?php if($lists): if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
								<div class="row addone">
									<div class="col-sm-2 col-md-2 col-lg-2"><?php echo $list['consignee']; ?></div>
									<div class="col-sm-4 col-md-4 col-lg-4"><?php echo $region_list[$list['province']]; ?><?php echo $region_list[$list['city']]; ?><?php echo $region_list[$list['district']]; ?><?php echo $region_list[$list['twon']]; ?><?php echo $list['address']; ?></div>
									<div class="col-sm-2 col-md-2 col-lg-2"><?php echo $list['mobile']; ?></div>
									<div class="col-sm-2 col-md-2 col-lg-2 modi"><a href="javascript:address_edit(<?php echo $list['address_id']; ?>)">修改</a>/<a href="<?php echo U('Home/User/del_address',array('id'=>$list['address_id'])); ?>">删除</a></div>
									<div class="col-sm-2 col-md-2 col-lg-2 amo">
										<?php if($list['is_default'] != 1): ?>
											<a href="<?php echo U('Home/User/set_default',array('id'=>$list['address_id'])); ?>">设为默认</a>
										<?php else: ?>
											<span>默认地址</span>
										<?php endif; ?>
									</div>
							...
							<h5 class="text-center style-red" style="padding: 10px 0;">暂无收货地址</h5>
						<?php endif; ?>
