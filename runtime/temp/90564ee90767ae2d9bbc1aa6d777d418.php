<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/article\categoryList.html";i:1512439953;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$vo): ?>
            ...
            <td class="sort">
              <div style="text-align: center; width: 60px;">
                <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onChange="changeTableVal('article_cat','cat_id','<?php echo $vo['cat_id']; ?>','sort_order',this)" size="4" value="<?php echo $vo['sort_order']; ?>" />
              </div>
            </td>
            <td class="name">
              <div style="text-align: left; width: 350px;">
                <input type="text" value="<?php echo $vo['name']; ?>" <?php if(in_array(($vo['id']), is_array($article_system_id)?$article_system_id:explode(',',$article_system_id))): ?>readonly="readonly"<?php endif; ?> onchange="changeTableVal('article_cat','cat_id',<?php echo $vo['cat_id']; ?>,'cat_name',this)"/>
              </div>
            </td>
            <td class="name">
              <div style="text-align: left; width: 350px;">
