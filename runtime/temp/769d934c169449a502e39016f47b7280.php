<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/mobile/new2/cart\cart.html";i:1512439835;s:41:"./template/mobile/new2/public\header.html";i:1512439863;s:45:"./template/mobile/new2/public\header_nav.html";i:1512439863;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<script type="text/javascript">
    ...
    function switch_num(num,cart_id,store_count){
        ...
        if(num2 > store_count) { //保证 不超过库存
            layer.open({content:"当前商品库存剩余 "+store_count+"件",time:2})
