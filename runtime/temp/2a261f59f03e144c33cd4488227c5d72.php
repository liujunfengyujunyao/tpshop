<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"./template/pc/tfs/user\visit_log.html";i:1513818159;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:34:"./template/pc/tfs/user\footer.html";i:1509018229;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta name="keywords" content="<?php echo $tpshop_config['shop_info_store_keyword']; ?>" />
	<meta name="description" content="<?php echo $tpshop_config['shop_info_store_desc']; ?>" />
	<title>我的足迹-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
	...
	<?php endif; ?>
			...
			<div class="col-md-10">
				...
				<div class="my_right">
					...
					<?php if(is_array($visit_list) || $visit_list instanceof \think\Collection || $visit_list instanceof \think\Paginator): $i = 0; $__LIST__ = $visit_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
						<div class="list">
							<div class="col-md-4">
								<dl>
									<dt><img src="<?php echo goods_thum_images($list['goods_id'],140,140); ?>" /></dt>
									<dd>
										<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$list['goods_id'])); ?>"><?php echo $list['goods_name']; ?></a>
									</dd>
									<dd class="se">商品货号：<?php echo $list['goods_sn']; ?></dd>
								</dl>
							</div>
							<div class="col-md-4 already">￥<?php echo $list['shop_price']; ?></div>
							<div class="col-md-4 shou" align="center" style="padding-top: 2%;">
								<?php echo date('Y-m-d H:i:s',$list['visittime']); ?>
							</div>
