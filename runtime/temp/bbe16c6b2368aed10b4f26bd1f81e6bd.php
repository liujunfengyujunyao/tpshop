<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"./template/pc/rainbow/partner\invoice_list.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
						...
						<table width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td width="25%"><?php echo $vo['express_code']; ?></td>
									<td width="20%"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></td>
									<td width="15%"><?php echo $vo['user_name']; ?></td>
									<td width="20%">
										<p><a href="<?php echo U('Partner/invoiceInfo', array('id'=>$vo['id'])); ?>">查看详情</a></p>
