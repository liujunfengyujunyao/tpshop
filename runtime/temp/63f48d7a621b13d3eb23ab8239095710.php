<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./template/pc/rainbow/partner\store_apply.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>工厂店补货申请记录-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
					...
					<div class="accbala">
						<table width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="20%"><?php echo $vo['store_name']; ?></td>
									...
									<td width="15%">
										<p><a href="<?php echo U('Partner/store_apply_info', array('id'=>$vo['id'])); ?>">查看详情</a></p>
										<?php if($vo['delivery_id']): ?>
										<p><a href="<?php echo U('Partner/delivery_info', array('id'=>$vo['delivery_id'])); ?>">配货单</a></p>
										<?php endif; ?>
									</td>
								</tr>
