<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"./template/pc/tfs/order\return_goods_list.html";i:1513818158;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="col-md-10 col-sm-9 col-lg-10">
				...
				<div class="my_right">
					<div class="per_main_r">
						<form action="<?php echo U('Home/Order/return_goods_list'); ?>" method="post">
							<ul class="good_back">
								<li>
									<label>退货状态:</label>
						...
						<div class="stock_list_main">
							...
							<?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
									<ul class="stock_log_goods">
										...
										<li class="width-sx"><a href="<?php echo U('Home/Order/return_goods_info',array('id'=>$v[id])); ?>" class="view">查看详情</a></li>
									</ul>
