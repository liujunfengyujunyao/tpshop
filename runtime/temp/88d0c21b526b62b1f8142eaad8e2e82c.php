<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view2/goods\categoryList.html";i:1519984570;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <td class="handle">
                <div style="text-align:center;   min-width:150px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    ...
                    <li><a href="<?php echo U('Goods/delGoodsCategory',array('id'=>$vo['id'])); ?>">删除当前分类</a></li>
                  </ul>
                  </span>
                </div>
              </td>
