<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./template/pc/tfs/partner\delivery_list.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
					...
					<div class="col-md-10 my_right">
						...
						<div class="parti">
							<div class="col-md-2 one"><?php echo $vo['store_name']; ?></div>
							<div class="col-md-2 one"><?php echo $vo['name']; ?></div>
							<div class="col-md-2 one"><?php echo $vo['phone']; ?></div>
							<div class="col-md-2 one"><?php echo $vo['province_name']; ?> <?php echo $vo['city_name']; ?> <?php echo $vo['town_name']; ?></div>
							<div class="col-md-2 one"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></div>
							<div class="col-md-2 one">
							<a href="<?php echo U('Partner/delivery_info', array('id'=>$vo['id'])); ?>">查看详情</a>
							</div>
						</div>
