<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:34:"./template/pc/tfs/user\coupon.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    <meta name="keywords" content="<?php echo $tpshop_config['shop_info_store_keyword']; ?>" />
    <meta name="description" content="<?php echo $tpshop_config['shop_info_store_desc']; ?>" />
    <title>我的优惠券-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
                    ...
                    <div class="col-md-10 my_right">
                        ...
                        <div class="row">
                            <div class="col-xs-12 set">
                                <ul class="pull-left list-inline">
                                    <li>
                                        <a href="<?php echo U('/Home/User/coupon'); ?>" class="<?php if(\think\Request::instance()->param('type') == ''): ?>current<?php endif; ?>">全部</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo U('/Home/User/coupon',array('type'=>3)); ?>" class="<?php if(\think\Request::instance()->param('type') == 3): ?>current<?php endif; ?>">未使用</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo U('/Home/User/coupon',array('type'=>1)); ?>" class="<?php if(\think\Request::instance()->param('type') == 1): ?>current<?php endif; ?>">已使用</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo U('/Home/User/coupon',array('type'=>2)); ?>" class="<?php if(\think\Request::instance()->param('type') == 2): ?>current<?php endif; ?>">已失效</a>
                                    </li>
                                </ul>
                                <a href="<?php echo U('Home/Activity/coupon_list'); ?>" class="pull-right btn btn-danger">领取优惠券</a>
                            </div>
                        </div>
                        <div class="top">
                        ...
                        <?php if($coupon_list): if(is_array($coupon_list) || $coupon_list instanceof \think\Collection || $coupon_list instanceof \think\Paginator): $i = 0; $__LIST__ = $coupon_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <div class="parti">
                            <div class="col-md-3 img">
                                <div class=" <?php if($vo['pred'] == '3'): ?>coupon_img_pic<?php else: ?>coupon_img_pic2<?php endif; ?>">
                                    <div class="coupon_img_bor">
                                        <div class="coupon_bor_left">
                                            <h5><?php echo intval($vo['money']); ?></h5>
                                        </div>  
                                        <div class="coupon_bor_right">
                                            <h5><?php echo $vo['name']; ?></h5>
                                            <p>Coupons</p>
                                            <h6>满<?php echo intval($vo['condition']); ?>元使用</h6>
                                        </div>
                            ...
                            <div class="col-md-2 one">￥<?php echo $vo['money']; ?></div>
                            <div class="col-md-3 one">满<?php echo $vo['condition']; ?>元使用</div>
                            <div class="col-md-2 one"><?php echo date("Y.m.d",$vo['use_end_time']); ?></div>
                            <div class="col-md-2 one">
                                <?php if($vo['pred'] == '3'): ?>
                                <span class="red">未使用</span>
                                <?php elseif($vo['pred'] == '1'): ?>
                                已使用
                                <?php else: ?>
                                已失效
                                <?php endif; ?>
                        ...
                        <div class="partia">
                            <?php if(\think\Request::instance()->param('type') == ''): ?>
                            还没有优惠券，<a href="<?php echo U('Home/Activity/coupon_list'); ?>" class="style-red">快去领取吧~</a>
                            <?php elseif(\think\Request::instance()->param('type') == 3): ?>
                            还没有可使用的优惠券，<a href="<?php echo U('Home/Activity/coupon_list'); ?>" class="style-red">快去领取吧~</a>
                            <?php else: ?>
                            暂无记录~
                            <?php endif; ?>
                        </div>
