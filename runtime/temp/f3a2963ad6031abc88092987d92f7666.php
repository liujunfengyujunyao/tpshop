<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"./template/pc/tfs/order\lower_list.html";i:1519984596;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>我的推广-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
            ...
            <div class="col-md-10 col-sm-9 col-lg-10 member_main">
                <div class="member_title"><h4>店会员列表</h4></div>
                            ...
                            <table>
                                ...
                                <?php if(empty($member) || (($member instanceof \think\Collection || $member instanceof \think\Paginator ) && $member->isEmpty())): ?>
                                    <tr class="member_o_con">
                                        <td style="color:#ff0000">暂无下线会员</td>
                                    </tr>
                                <?php else: if(is_array($member) || $member instanceof \think\Collection || $member instanceof \think\Paginator): $i = 0; $__LIST__ = $member;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="member_o_con">
                                        <td><?php echo $vo['user_id']; ?></td>
                                        <td><?php echo (isset($vo['mobile']) && ($vo['mobile'] !== '')?$vo['mobile']:'--'); ?></td>
                                        <td><?php echo (isset($vo['nickname']) && ($vo['nickname'] !== '')?$vo['nickname']:'--'); ?></td>
                                        <td><?php echo date('Y-m-d H:s',$vo['reg_time']); ?></td>
                                        <td><?php echo date('Y-m-d H:s',$vo['last_login']); ?></td>
                                    </tr>
