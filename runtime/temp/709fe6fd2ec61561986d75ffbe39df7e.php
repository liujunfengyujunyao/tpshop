<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/admin/view2/comment\ajaxindex.html";i:1512439955;}*/ ?>
<table>
 	<tbody>
  	...
  	<tr data-id="<?php echo $list['comment_id']; ?>">
        ...
        <td align="center" abbr="article_time" axis="col6" class="">
               <div style="text-align: center; width: 160px;" class="">
       			...
       			<a class="btn red"  href="javascript:void(0);" onclick="publicHandle('<?php echo $list[comment_id]; ?>')" ><i class="fa fa-trash-o"></i>删除</a>
       		</div>
           </td>
