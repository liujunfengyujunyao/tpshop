<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"./template/pc/tfs/partner\invoice_list.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<!--my end-->
			...
			<!--my end-->
			<div class="container">
				<?php $pid =407;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520218800 and end_time > 1520218800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
	...
	<?php endif; ?>
					...
					<div class="col-md-10 my_right">
						...
						<div class="parti">
							...
							<div class="col-md-3 one"><?php echo $vo['express_code']; ?></div>
							<div class="col-md-3 one"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></div>
							<div class="col-md-2 one"><?php echo $vo['user_name']; ?></div>
							<div class="col-md-2 <?php if(empty($vo['confirm_time'])): ?>yes<?php else: ?>one<?php endif; ?>">
							<a href="<?php echo U('Partner/invoiceInfo', array('id'=>$vo['id'])); ?>">查看详情</a></br>
