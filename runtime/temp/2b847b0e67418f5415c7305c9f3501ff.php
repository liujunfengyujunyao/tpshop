<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user\index.html";i:1512439954;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <form class="navbar-form form-inline"  id="search-form2" onsubmit="return false">
                ...
                <div class="sDiv">
                    <div class="sDiv2" style="margin-right: 10px;border: none;">
                        <select name="first_leader" id="first_leader">
                            <option value="">所有工厂店</option>
                            <?php if(is_array($storelist) || $storelist instanceof \think\Collection || $storelist instanceof \think\Paginator): if( count($storelist)==0 ) : echo "" ;else: foreach($storelist as $k=>$s): ?>
                                <option value="<?php echo $s['user_id']; ?>"><?php echo $s['store_name']; ?></option>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 70px;">所属工厂店</div>
                        </th>
