<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view2/system\navigationList.html";i:1512439953;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton"> <a href="<?php echo U('Admin/System/addEditNav'); ?>">
                        ...
                        <tr>
                            ...
                            <td class="sort">
                                <div style="text-align: center; width: 150px;">
                                    <input style="text-align: center;" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onchange="changeTableVal('navigation','id','<?php echo $vo['id']; ?>','sort',this)"  size="4"  value="<?php echo $vo['sort']; ?>" />
                                </div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    ...
                                    <?php endif; ?>
                                    <a class="btn red" href="<?php echo U('System/delNav',array('id'=>$vo['id'])); ?>"><i class="fa fa-trash-o"></i>删除</a>
                                    <a href="<?php echo U('Admin/System/addEditNav',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a> </div>
                            </td>
