<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./template/pc/rainbow/partner\stock_log.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>库存日志-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
<link rel="stylesheet" type="text/css" href="__STATIC__/css/tpshop.css" />
<link rel="stylesheet" type="text/css" href="__STATIC__/css/myaccount.css" />
<script src="__STATIC__/js/jquery-1.11.3.min.js" type="text/javascript" charset="utf-8"></script>
<script src="__PUBLIC__/js/layer/layer.js"></script>
<style>
#stockLog .sx1 {width: 60%}
#stockLog .sx2 {width: 20%}
#stockLog .sx3 {width: 20%}
#stockLog .empty {text-align: center; padding: 10px 0; font-size: 16px}
</style>
</head>
<body class="bg-f5">
...
<div class="home-index-middle">
	<div class="w1224">
		...
		<div class="home-main" id="stockLog">
				...
				<div class="menumain p">
					...
					<div class="card-list accbala">
						<ul>
							...
							<li class="sx2"><span>库存</span></li>
							<li class="sx3"><span>変动时间</span></li>
						</ul>
					</div>
					<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="card-list c_contan accbala-list">
							<ul>
								<li class="sx1"><span><?php echo $vo['goods_name']; ?></span></li>
								<li class="sx2"><span><?php echo $vo['stock']; ?></span></li>
								<li class="sx3"><span><?php echo date("Y-m-d H:i:s",$vo['ctime']); ?></span></li>
							</ul>
						</div>
