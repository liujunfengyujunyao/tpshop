<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/admin\supplier.html";i:1512439956;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<div class="fbutton"> <a href="<?php echo U('Admin/supplier_info'); ?>">
							...
							<td align="center" class="">
								<div style="text-align: center; width: 80px;">
									<?php if($vo[is_check] == 1): ?>
										<span class="yes" onClick="changeTableVal('suppliers','suppliers_id','<?php echo $vo['suppliers_id']; ?>','is_check',this)" ><i class="fa fa-check-circle"></i>是</span>
										<?php else: ?>
										<span class="no" onClick="changeTableVal('suppliers','suppliers_id','<?php echo $vo['suppliers_id']; ?>','is_check',this)" ><i class="fa fa-ban"></i>否</span>
									<?php endif; ?>
								</div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Admin/supplier_info',array('suppliers_id'=>$vo['suppliers_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<a class="btn red" href="javascript:void(0)" data-url="<?php echo U('Admin/supplierHandle'); ?>" data-id="<?php echo $vo['suppliers_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
