<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"./template/pc/tfs/partner\store_apply.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>工厂店补货申请记录</title>
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
            ...
            <div class="col-md-10 col-sm-9 col-lg-10 add_g_main">
                <div class="add_g_title"><h4>补货申请记录</h4></div>
                            ...
                            <table>
                                ...
                                <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="a_c_con">
                                        ...
                                        <td><?php echo (isset($vo['express_name']) && ($vo['express_name'] !== '')?$vo['express_name']:"无"); ?></td>
                                        <td><?php echo (isset($vo['express_code']) && ($vo['express_code'] !== '')?$vo['express_code']:"无"); ?></td>
                                        <td><span>
                                            <?php if($vo[status] == 0): ?>处理中<?php endif; if($vo[status] == 1): ?>已处理<?php endif; if($vo[status] == 2): ?>申请失败<?php endif; ?>
                                        </span></td>
                                        <td><a href="<?php echo U('Home/Partner/apply_info', array('id'=>$vo['id'])); ?>">查看详情</a></td>
                                    </tr>
