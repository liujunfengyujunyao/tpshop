<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"./application/admin/view2/order\refund_order_list.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="sDiv">
        ...
        <div class="sDiv2">	 
			<input type="text" size="30" id="order_sn" name="mobile" value="<?php echo $_POST['mobile']; ?>" class="qsbox"  placeholder="联系电话">
        </div>
        <div class="sDiv2">	 
