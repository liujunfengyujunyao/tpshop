<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/promotion\prom_order_list.html";i:1512439957;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="left" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									...
									<a class="btn red" href="<?php echo U('Promotion/prom_order_del',array('id'=>$vo['id'])); ?>"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
