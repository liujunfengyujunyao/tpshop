<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:35:"./template/pc/tfs/user\account.html";i:1513906931;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>我的积分</title>
                ...
                <div class="my_right per_main_r">
                    <div class="">
                        <div class="integral_top">
                            <div class="integral_l"><h5>可用积分<span><?php echo $user['pay_points']; ?></span></h5></div>
                            <div class="integral_l"><h5>可用余额<span><?php echo $user['user_money']; ?></span></h5></div>
                            <div class="integral_l"><a href="<?php echo U('Home/Goods/integralMall'); ?>">兑换超值商品与优惠劵</a></div>
                        </div>
                        ...
                        <div class="integral_bot">
                            ...
                            <div class="integral_title">
                                ...
                                <?php endif; if(is_array($account_log) || $account_log instanceof \think\Collection || $account_log instanceof \think\Paginator): $i = 0; $__LIST__ = $account_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;if($log['pay_points'] != 0): ?>
                                        <ul>
                                            <li><?php echo (isset($log['order_sn']) && ($log['order_sn'] !== '')?$log['order_sn']:'无'); ?></li>
                                            <li><?php echo $log['desc']; ?></li>
                                            <li><span><?php if($log[pay_points] > 0): ?>+<?php endif; ?><?php echo $log['pay_points']; ?></span></li>
                                            <li><?php echo date('Y-m-d H:i',$log['change_time']); ?></li>
                                        </ul>
