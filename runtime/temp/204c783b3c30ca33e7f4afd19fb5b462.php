<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:36:"./template/pc/tfs/user\recharge.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>账户余额</title>
                    ...
                    <div class="account_o_t">
                        <table>
                            ...
                            <tr class="member_o_con">
                                ...
                                <?php if($user['level'] == 9 || $user['level'] == 8): ?>
                                <td><a href="<?php echo U('Home/User/withdrawals'); ?>">提现</a></td>
                                <?php endif; ?>
                            </tr>
                        </table>
                    </div>
                        ...
                        <div class="account_detail">
                            ...
                            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                <tr class="account_det_con">
                                    <td><?php echo date('Y-m-d H:i:s',$list['change_time']); ?></td>
                                    <td  class="accout_mon"><?php echo $list['user_money']; ?></td>
