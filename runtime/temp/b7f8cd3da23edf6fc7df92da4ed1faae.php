<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/goods\brandList.html";i:1512439954;s:44:"./application/admin/view2/public\layout.html";i:1512439956;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <div class="bDiv" style="height: auto;">
      <div id="flexigrid" cellpadding="0" cellspacing="0" border="0" data-url="<?php echo U('Admin/goods/delBrand'); ?>">
        <table>
          <tbody>
            <?php if(is_array($brandList) || $brandList instanceof \think\Collection || $brandList instanceof \think\Paginator): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
              <tr data-id="<?php echo $list[id]; ?>">
                <td class="sign">
                  ...
                  <td align="left" class="">
                      <div style="text-align: center; width: 50px;"><?php echo $list['id']; ?></div>
                  </td>
                <td align="left" class="">
                ...
                <td align="center" class="">
                  <div style="text-align: center; width: 200px;"><?php echo $cat_list[$list[parent_cat_id]]; ?> <?php echo $cat_list[$list[cat_id]]; ?></div>
                </td>                
                <td align="center" class="">
              ...
              <td align="center">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 100px;">                    
                    <a class="btn red"  href="javascript:void(0)"  onclick="publicHandle('<?php echo $list[id]; ?>','del')" ><i class="fa fa-trash-o"></i>删除</a>
