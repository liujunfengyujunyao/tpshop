<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:48:"./template/mobile/new2/activity\coupon_list.html";i:1512439864;s:41:"./template/mobile/new2/public\header.html";i:1512439863;s:45:"./template/mobile/new2/public\header_nav.html";i:1512439863;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
				...
				<div class="maleri30">
					<div class="alcowlone p">
						...
						<div class="get-limit fr">
							<canvas class="alreadyget" data-num='<?php if($vo[createnum] > 0): ?><?php echo ceil($vo[send_num]/$vo[createnum]*100); else: ?>0<?php endif; ?>'  width="100"  height="100"></canvas>
							<?php if($vo[send_num] == $vo[createnum]): ?>
								<a class="clickgetcoupon" data-coupon-id="<?php echo $vo['id']; ?>" onclick="getCoupon(this)">已抢完</a>
								<?php else: ?>
