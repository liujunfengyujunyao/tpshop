<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/article\articleList.html";i:1533876247;s:44:"./application/admin/view2/public\layout.html";i:1533876247;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 174px; max-width:174px;"> <a class="btn blue"  href="<?php echo U('Home/Article/detail',array('article_id'=>$vo['article_id'])); ?>"><i class="fa fa-search"></i>查看</a>
                    <?php if(!in_array(($vo['article_id']), is_array($article_able_id)?$article_able_id:explode(',',$article_able_id))): ?> <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Article/aticleHandle'); ?>" data-id="<?php echo $vo['article_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a> <?php endif; if(in_array(($vo['article_id']), is_array($article_able_id)?$article_able_id:explode(',',$article_able_id))): ?> <a class="btn red"  href="javascript:layer.alert('该文章不得删除!',{icon:2});"><i class="fa fa-trash-o"></i>删除</a> <?php endif; ?>
