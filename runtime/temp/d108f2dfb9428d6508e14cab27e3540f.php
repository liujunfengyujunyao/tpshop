<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/order\index.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
	        	...
	        	<tr>
	              ...
	              <!--<th align="center" abbr="article_time" axis="col6" class="">
                    ...
                    <th align="center" abbr="safecode" axis="col6" class="">
                        <div style="text-align: center; width:120px;" class="">核销编码</div>
                    </th>
