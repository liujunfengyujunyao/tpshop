<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/order\invoice_print.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection || $orderGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
              <tr>
                <td colspan="2" style="text-align: center;"><a href="<?php echo U('Goods/addEditGoods',array('id'=>$goods['goods_id'])); ?>" target="_blank"><?php echo $goods['goods_name']; ?></a><br/></td>
