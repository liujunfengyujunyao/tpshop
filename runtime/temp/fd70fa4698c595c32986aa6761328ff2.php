<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./template/pc/rainbow/store\store_stock_list.html";i:1512439865;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>库存管理-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
		...
		<?php endif; ?>
			...
			<div class="ri-menu fr">
				<div class="menumain p">
					<div class="goodpiece">
						<h1><?php echo $store_name; ?> - 库存列表</h1>
					...
					<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="card-list c_contan accbala-list">
							<ul>
								...
								<li class="sx2"><span <?php if($vo['goods_num'] <= ($storeage/100)*($vo['stock_num'])): ?>class="red"<?php endif; ?>><?php if($vo['goods_num'] == null): ?> 0<?php else: ?><?php echo $vo['goods_num']; endif; ?>/ <?php echo $vo['stock_num']; ?></span></li>
								<li class="sx3"><span><?php if($vo['edittime'] == null): ?>无<?php else: ?><?php echo date("Y-m-d H:i:s",$vo['edittime']); endif; ?></span></li>
							</ul>
						</div>
