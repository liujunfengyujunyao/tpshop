<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/partner\stock_list.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
					...
					<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="card-list c_contan accbala-list">
							<ul>
								...
								<li class="sx2"><span <?php if($vo['goods_num'] <= ($storeage/100)*($vo['stock_num'])): ?>class="red"<?php endif; ?>><?php echo (isset($vo['goods_num']) && ($vo['goods_num'] !== '')?$vo['goods_num']:"0"); ?> / <?php echo $vo['stock_num']; ?></span></li>
								<li class="sx3"><span><?php echo (isset($vo['edittime']) && ($vo['edittime'] !== '')?$vo['edittime']:"无"); ?></span></li>
							</ul>
						</div>
