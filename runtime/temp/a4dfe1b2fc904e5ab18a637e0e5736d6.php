<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./template/pc/tfs/store\store_stock_list.html";i:1519984570;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  <meta name="keywords" content="<?php echo $tpshop_config['shop_info_store_keyword']; ?>" />
  <meta name="description" content="<?php echo $tpshop_config['shop_info_store_desc']; ?>" />
  <title>库存列表-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
	...
	<?php endif; ?>
          ...
          <div class="col-md-10 my_right">
            ...
            <div class="list">
              <div class="col-md-4">
                <dl>
                  <dt><img src="<?php echo goods_thum_images($vol['goods_id'],120,120); ?>" /></dt>
                  <dd><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vol['goods_id'])); ?>"><?php echo $vol['goods_name']; ?></a></dd>
                  <dd class="se">商品货号：<?php echo $vol['goods_sn']; ?></dd>
                </dl>
              </div>
              <div class="col-md-4 already">
              <font <?php if($vol['goods_num'] <= ($storeage/100)*($vol['stock_num'])): ?> color="red"<?php endif; ?>><?php if($vol['goods_num'] == null): ?> 0<?php else: ?><?php echo $vol['goods_num']; endif; ?></font>/ <?php echo $vol['stock_num']; ?>
              </div>
              <div class="col-md-4 shou" align="center" style="padding-top: 2%;"><?php if($vol['edittime'] == null): ?>无<?php else: ?><?php echo date("Y-m-d H:i:s",$vol['edittime']); endif; ?></div>
            </div>
