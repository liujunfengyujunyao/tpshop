<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./template/pc/rainbow/store\delivery_list.html";i:1512439865;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
					...
					<div class="accbala">
						<table width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="15%"><?php echo $vo['nickname']; ?></td>
									<td width="15%"><?php echo $vo['mobile']; ?></td>
									<td width="15%"><?php echo $vo['express_name']; ?></td>
									<td width="15%"><?php echo $vo['express_code']; ?></td>
									<td width="20%"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></td>
									<td width="20%">
										<p><a href="<?php echo U('Store/delivery_info', array('id'=>$vo['id'])); ?>">查看详情</a></p>
										<?php if(empty($vo['confirm_time'])): ?><p><a href="javascript:void(0)" onclick="order_confirm(<?php echo $vo['id']; ?>)" class="confirm">确认收货</a></p><?php endif; ?>
									</td>
								</tr>
