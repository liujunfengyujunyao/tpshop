<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"./template/pc/rainbow/order\comment.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<!--------收货地址，物流运费--结束-------------->
		...
		<div class="home-index-middle">
			<div class="w1224">
				<div class="g-crumbs">
			       	<a href="<?php echo U('Home/Order/index'); ?>">我的商城</a>
			       	<i class="litt-xyb"></i>
			       	<span>我的评价</span>
			    </div>
			    <div class="home-main">
												...
												<td class="sx6">
													<div class="rbac">
														<?php if($list['is_comment'] == 1): ?>
															...
															<?php else: ?>
															<p class="inspect"><a href="<?php echo U('Home/Order/comment_list',array('order_id'=>$list['order_id'],'goods_id'=>$list['goods_id'])); ?>">评价</a>
														<?php endif; ?>
