<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/mobile/new2/user\address_list.html";i:1512439863;s:41:"./template/mobile/new2/public\header.html";i:1512439863;s:45:"./template/mobile/new2/public\header_nav.html";i:1512439863;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
            ...
            <div class="maleri30">
               ...
               <a href="<?php echo U('/Mobile/Cart/cart2',array('address_id'=>$list['address_id'])); ?>">
                ...
                <div class="editdiv fl">
                    ...
                    <?php else: ?>
                        <a href="<?php echo U('/Mobile/User/edit_address',array('id'=>$list[address_id],'source'=>\think\Request::instance()->param('source'),'act_id'=>\think\Request::instance()->param('act_id'),'goods_num'=>\think\Request::instance()->param('goods_num'))); ?>">
                            <i class="eedit"></i>
                        </a>
                    <?php endif; ?>
                </div>
...
<!--地址-e-->
    <div class="hek">
        <div class="createnew">
            ...
            <?php else: ?>
                <a href="<?php echo U('/Mobile/User/add_address',array('source'=>\think\Request::instance()->param('source'),'act_id'=>\think\Request::instance()->param('act_id'),'goods_num'=>\think\Request::instance()->param('goods_num'))); ?>">+新建地址</a>
            <?php endif; ?>
        </div>
    </div>
</body>
