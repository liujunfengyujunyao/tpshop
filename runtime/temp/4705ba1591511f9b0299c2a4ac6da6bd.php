<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/pc/tfs/partner\invoice_info.html";i:1504950685;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:42:"./template/pc/tfs/public\footer_index.html";i:1509018228;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>发货单详情-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
				...
				<div class="menumain p">
					<div class="beenovercom">
						...
						<div>
							<div class="base-info">
								<ul>
									<li>操作用户：<?php echo $info['user_name']; ?></li>
									<li>物流名称：<?php echo $info['express_name']; ?></li>
									<li>物流单号：<?php echo $info['express_code']; ?></li>
									<li>发货时间：<?php echo date("Y-m-d H:i:s",$info['addtime']); ?></li>
									<?php if(!empty($info['confirm_time'])): ?><li>收货时间：<?php echo $info['confirm_time']; ?></li><?php endif; ?>
								</ul>
							</div>
							<div class="order-alone-li">
								<table width="100%">
									...
									<tbody>
										<?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection || $orderGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
										<tr class="conten_or">
											<td class="sx1">
							...
							<?php if(empty($info['confirm_time'])): ?>
							<div class="numzjsehe">
								<a class="ddn3" href="javascript:void(0)" onclick="order_confirm(<?php echo \think\Request::instance()->param('id'); ?>)">确认收货</a>
							</div>
							<?php endif; ?>
						</div>
					</div>
