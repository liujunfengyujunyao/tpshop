<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index\index.html";i:1519984569;s:45:"./application/admin/view2/public\menubox.html";i:1519984569;s:42:"./application/admin/view2/public\left.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'肽风尚商城'); ?> </title>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
    ...
    <img src="__PUBLIC__/static/images/logo.png" alt="">
  </div>
  <div class="nc-module-menu">
    <ul class="nc-row">
      <!-- 修改顶部菜单为动态读取Start @author Dh 2017-7-26 -->
      ...
      <li data-param="<?php echo $k; ?>"><a href="javascript:void(0);"><?php echo $vo['name']; ?></a></li>
      <?php endforeach; endif; else: echo "" ;endif; ?>
      <!-- 修改顶部菜单为动态读取End @author Dh 2017-7-26 -->
    </ul>
  </div>
