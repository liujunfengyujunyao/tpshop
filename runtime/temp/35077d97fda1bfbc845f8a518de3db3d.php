<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/partner\invoice.html";i:1512439953;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" method="post" action="<?php echo U('Partner/invoice'); ?>" id="search-form2" onsubmit="return check_form();">
							...
							<tr>
								...
								<td align="center" class="">
									<div style="text-align: center; width: 80px;">
										<a class="btn green" href="<?php echo U('Admin/Partner/invoice_info',array('id'=>$v['id'])); ?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情"><i class="fa fa-list-alt"></i>详情</a>
									</div>
								</td>
							</tr>
