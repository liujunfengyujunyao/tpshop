<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./template/pc/tfs/cart\replace_pickup.html";i:1509018228;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="adderss-add">
    <div class="ner-reac ol_box_4" style="visibility: visible; position: fixed; z-index: 500; width: 100%; height:100%">
        <div class="box-ct">
            ...
            <form action="<?php echo U('Home/User/save_pickup'); ?>" method="post" onSubmit="return checkForm()">
...
<script>
    ...
    function select_pick_up(){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo U('Home/Cart/ajax_PickupPoint'); ?>",
            dataType:"json",
