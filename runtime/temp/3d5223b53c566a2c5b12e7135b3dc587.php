<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"./template/pc/tfs/store\stock_log.html";i:1519984570;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="col-md-10 my_right">
				...
				<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="list">
							<div class="col-md-4">
								<dl>
									<dt><img src="<?php echo goods_thum_images($vo['goods_id'],120,120); ?>" /></dt>
									<dd>
										<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>"><?php echo $vo['goods_name']; ?></a>
									</dd>
									<dd class="se">商品货号：<?php echo $vo['goods_sn']; ?></dd>
								</dl>
							</div>
							<div class="col-md-4 already"><?php echo $vo['stock']; ?></div>
