<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view2/admin\log.html";i:1512439956;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form1" method="post">
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="controller" id="controller">
							...
							<?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
								<option value="<?php echo $m['controller']; ?>"><?php echo $m['name']; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
					<div class="sDiv2">
						<input class="btn" value="筛选" type="submit"/>
					</div>
				</div>
			</form>
		</div>
			...
			<div class="hDivBox">
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="controller" axis="col5" class="">
							<div style="text-align: left; width: 100px;" class="">操作类型</div>
						</th>
						<th align="left" abbr="ac_id" axis="col4" class="">
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $temp[$vo[controller]]; ?></div>
							</td>
							<td align="left" class="">
