<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/partner\store_list.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>工厂店管理-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
<link rel="stylesheet" type="text/css" href="__STATIC__/css/tpshop.css" />
<link rel="stylesheet" type="text/css" href="__STATIC__/css/myaccount.css" />
<script src="__STATIC__/js/jquery-1.11.3.min.js" type="text/javascript" charset="utf-8"></script>
<script src="__PUBLIC__/js/layer/layer.js"></script>
<style>
#storeList .accbala ul li, #storeList .accbala-list ul li {width: 16.5%;}
#storeList .empty {text-align: center; padding: 10px 0; font-size: 16px}
</style>
</head>
<body class="bg-f5">
...
<div class="home-index-middle">
	<div class="w1224">
		...
		<div class="home-main" id="storeList">
		...
		<?php endif; ?>
			...
			<div class="ri-menu fr">
				<div class="menumain p">
					<div class="goodpiece">
						<h1>工厂店管理 </h1>
						<span>（已发展 <em class="red"><?php echo $pager->totalRows; ?></em> 个工厂店）</span>
					</div>
					<div class="card-list accbala">
						<ul>
							<li><span>工厂店名称</span></li>
							<li><span>负责人</span></li>
					...
					<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="card-list c_contan accbala-list">
							<ul>
								<li><span><?php echo $vo['store_name']; ?></span></li>
								<li><span><?php echo $vo['nickname']; ?></span></li>
								<li><span><?php echo $vo['phone']; ?></span></li>
								<li><span><?php echo $vo['type_name']; ?></span></li>
								<li><span><?php echo $vo['addtime']; ?></span></li>
								<li>
									<a href="<?php echo U('Partner/store_stock_list', array('id'=>$vo['store_id'])); ?>">查看库存</a></li>
							</ul>
						</div>
