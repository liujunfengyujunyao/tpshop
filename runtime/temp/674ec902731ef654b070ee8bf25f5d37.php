<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:41:"./template/pc/tfs/partner\stock_list.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
	...
	<?php endif; ?>
          ...
          <div class="col-md-10 my_right">
            ...
            <div class="list">
              ...
              <div class="col-md-4 shou" align="center" style="padding-top: 2%;"><?php if($vol['edittime'] == null): ?>无<?php else: ?><?php echo $vol['edittime']; endif; ?></div>
            </div>
 ...
 */
function apply() {
	var url = "/index.php?m=Home&c=Partner&a=act_apply";
	layer.open({
		type: 2,
		title: '申请补货',
		shadeClose: true,
