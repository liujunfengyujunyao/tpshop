<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/system\shop_info.html";i:1533876247;s:44:"./application/admin/view2/public\layout.html";i:1533876247;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">方便客户遇到问题时咨询，只允许填写一个电话</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <select onchange="get_area2(this);" id="city" name="city">
