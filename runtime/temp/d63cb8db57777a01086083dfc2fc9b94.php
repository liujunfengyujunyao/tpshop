<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:41:"./template/pc/tfs/partner\order_list.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
            ...
            <div class="col-md-10 col-sm-9 col-lg-10 member_main">
                <div class="member_title"><h4>工厂店订单</h4></div>
                            ...
                            <table>
                                ...
                                <?php else: if(is_array($orderList) || $orderList instanceof \think\Collection || $orderList instanceof \think\Paginator): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr class="member_o_con">
                                        ...
                                        <td><a href="<?php echo U('Partner/orderInfo', array('id'=>$vo['order_id'])); ?>">查看详情</a></td>
                                    </tr>
