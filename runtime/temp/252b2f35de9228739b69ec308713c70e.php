<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/order\add_order.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form class="form-horizontal" action="<?php echo U('Admin/Order/add_order'); ?>" id="order-add" method="post">    
    <div class="ncap-form-default">
      ...
      <dl class="row">
          <dt class="tit">
              <label for="shop_way"><em>*</em>配送方式</label>
          </dt>
          <dd class="opt">
              <select id="shop_way" name="shop_way">
                  <option value="1">默认物流方式</option>
                  <option value="2" selected="selected">风尚工厂店</option>
                  <option value="3">风尚自提点</option>
              </select>
          </dd>
      </dl>
      <dl class="row store" id="store_1" style="display: none;">
        <dt class="tit">
      ...
      <dl class="row store" id="store_2">
          <dt class="tit">
              <label for="store_1"><em>*</em>配送工厂店</label>
          </dt>
          <dd class="opt">
              <select id="store_id" name="store_id">
                  <?php if(is_array($store_list) || $store_list instanceof \think\Collection || $store_list instanceof \think\Paginator): $i = 0; $__LIST__ = $store_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?>
                      <option value="<?php echo $s['store_id']; ?>"><?php echo $s['store_name']; ?></option>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
          </dd>
      </dl>
      <dl class="row store" id="store_3" style="display: none;">
        <dt class="tit">
            <label for="store_2"><em>*</em>自提点</label>
        </dt>
        <dd class="opt">
            <select id="pickup_id" name="pickup_id">
                <?php if(is_array($pickup_list) || $pickup_list instanceof \think\Collection || $pickup_list instanceof \think\Paginator): $i = 0; $__LIST__ = $pickup_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pickup): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $pickup['pickup_id']; ?>"><?php echo $pickup['pickup_name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </dd>
      </dl>
