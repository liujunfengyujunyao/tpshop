<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/promotion\prom_goods_list.html";i:1512439957;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="article_show" axis="col5" class="">
							<div style="text-align: center; width: 300px;" class="">适用范围</div>
						</th>
		...
		<div class="tDiv">
			<div class="tDiv2">
				<a href="<?php echo U('Promotion/prom_goods_info'); ?>">
					<div class="fbutton">
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 300px;"><?php echo $vo['group_name']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue goods_list" data-url="<?php echo U('Promotion/get_goods',array('id'=>$vo['id'])); ?>"><i class="fa fa-search"></i>查看商品</a>
									<a class="btn blue" href="<?php echo U('Promotion/prom_goods_info',array('id'=>$vo['id'])); ?>"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<a class="btn red" href="<?php echo U('Promotion/prom_goods_del',array('id'=>$vo['id'])); ?>"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
