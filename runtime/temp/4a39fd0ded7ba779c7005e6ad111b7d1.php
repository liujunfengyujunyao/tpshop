<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"./template/pc/tfs/store\apply_info.html";i:1519984570;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>补货申请详情</title>
...
<div id="per_main">
    <div class="container">
        <?php $pid =406;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520215200 and end_time > 1520215200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
foreach($result as $key=>$v):       
	...
	<?php endif; ?>
            ...
            <div class="col-md-10 col-sm-9 col-lg-10 per_main_r">
                <div class="or_right_title"><h4><a href="<?php echo U('Home/Store/apply'); ?>">补货申请记录</a> / <a href="javascript:();">补货申请详情</a></h4>
                </div>
                <div class="per_con">
                    ...
                    <div class="order_survey"><h2>物流信息</h2>
                        ...
                        <dl class="dl-horizontal">
                            <dt>物流名称：</dt><dd><?php echo (isset($info['express_name']) && ($info['express_name'] !== '')?$info['express_name']:'暂无信息'); ?></dd>
                            <dt>物流单号：</dt><dd><?php echo (isset($info['express_code']) && ($info['express_code'] !== '')?$info['express_code']:'暂无信息'); ?></dd>
                            <dt>备注信息：</dt><dd><?php echo (isset($info['remark']) && ($info['remark'] !== '')?$info['remark']:'暂无信息'); ?></dd>
                        </dl>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="order_tracer_top">
                        ...
                        <ul>
                            ...
                            <li><div class="order_stage_bg"><div class=" 
                                <?php if($info[status] == 0): ?>order_stage_btn2"></div></div><p>审核通过<?php endif; if($info[status] == 1): ?>order_stage_btn1"></div></div><p>审核通过<?php endif; if($info[status] == 2): ?>order_stage_btn1"></div></div><p style="color:#ff0000;">审核失败<?php endif; ?>
                            </p></li>
                            <li><div class="order_stage_bg"><div class="<?php if($info[express_code]): ?>order_stage_btn1<?php else: ?>order_stage_btn2<?php endif; ?>"></div></div><p>管理员发货</p></li>
                            <li><div class="order_stage_bg"><div class="<?php if($info[delivery_time] > 0): ?>order_stage_btn1<?php else: ?>order_stage_btn2<?php endif; ?>"></div></div><p>等待收货</p></li>
                            <li><div class="order_stage_bg"><div class="<?php if($info[confirm_time]): ?>order_stage_btn1<?php else: ?>order_stage_btn2<?php endif; ?>"></div></div><p>完成</p></li>
                        </ul>
                    </div>
                    ...
                    <div class="order_tracer_sec">
                        <h3>订单跟踪详情</h3>
                            ...
                            <?php if($order_info[confirm_time] > 0): ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['confirm_time']); ?></span><span class="order_txt">您的补货申请已完成</span></li>
                            <?php endif; if($info[delivery_id] > 0): ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['delivery_time']); ?></span><span class="order_txt">您申请的商品正在等待收货</span></li>
                            <?php endif; if($info[express_code] > 0): ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['delivery_time']); ?></span><span class="order_txt">您申请的商品已发货</span></li>
                            <?php endif; if($info[status] == 1): ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['edittime']); ?></span><span class="order_txt">您的补货申请已审核通过</span></li>    
                            <?php endif; if($info[status] == 2): ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['edittime']); ?></span><span class="order_txt">管理员拒绝了您的补货申请</span></li>    
                            <?php endif; ?>
                                <li><div class="order_dot_bg"><div class="order_dot"></div></div><span class="order_time"><?php echo date('Y-m-d H:i:s',$info['addtime']); ?></span><span class="order_txt">您的补货申请已完成提交</span></li>
                            </ul>
                    </div>
                        ...
                        <tr class="order_bill_goods">
                            <td class="order_goods_img">
                                <div class="order_detail">
                                    <div class="order_detail_img"><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>"><img src="<?php echo goods_thum_images($vo['goods_id'],80,80); ?>" width="80" height="80"></a></div>
                                    <div class="order_detail_txt"><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>"><?php echo getSubstr($vo['goods_name'],0,20); ?></a><span>商品货号：<?php echo $vo['goods_sn']; ?></span></div>
                                </div>
                             </td>
