                ...
                <div class="my_right per_main_r">
                    <div class="stock_list_main">
                        ...
                        <?php if(empty($lists) || (($lists instanceof \think\Collection || $lists instanceof \think\Paginator ) && $lists->isEmpty())): ?>
                            <p class="text-center" style="padding: 10px 0">暂无记录</p>
                        ...
                        <ul class="collection_goods">
                            <li class="col_goods_img"><div class="goods_img_pic"><img src="<?php echo goods_thum_images($list['goods_id'],80,80); ?>" width="80" height="80" /></div>
                            <div class="goods_img_title"><h6><?php echo $list['goods_name']; ?></h6></div><p>商品货号：<?php echo $list['goods_sn']; ?></p></li>
                            <li><span><?php echo $list['shop_price']; ?></span></li>
                            <li><?php echo date("Y-m-d H:i:s",$list['add_time']); ?></li>
                            <li><a href="javascript:void(0)" onclick="AjaxAddCart(<?php echo $list[goods_id]; ?>,1,0);" class="collection_jion">加入购物车</a><a onclick="del_all(<?php echo $list[collect_id]; ?>)" href="javascript:" class="collection_cancel">取消收藏</a></li>
                        </ul>
