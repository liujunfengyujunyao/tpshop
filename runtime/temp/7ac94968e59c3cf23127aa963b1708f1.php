<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view2/store\withdrawals.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
		...
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" method="post" action="<?php echo U('withdrawals'); ?>" onsubmit="return check_form();">
				...
				<div class="sDiv">
					...
					<div class="sDiv2" style="margin-right: 5px;">
						<input size="30" name="store_name" value="<?php echo \think\Request::instance()->request('store_name'); ?>" placeholder="工厂店名称" class="qsbox" type="text">
					</div>
					<!-- <div class="sDiv2" style="margin-right: 5px;">
						...
						<tr>
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 100px; max-width: 100px;">
									<a href="<?php echo U('Store/editWithdrawals',array('id'=>$v['id'], 'p'=>$_GET[p])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
			...
			$.ajax({
				...
				success: function(v){
					...
					if(v.hasOwnProperty('status') && (v.status == 1)) {
						...
						location.href="<?php echo U('Admin/Store/withdrawals'); ?>";
					}else {
