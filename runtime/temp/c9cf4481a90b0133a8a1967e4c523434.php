<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/mobile/new2/index\index.html";i:1519984628;s:41:"./template/mobile/new2/public\footer.html";i:1512439863;s:45:"./template/mobile/new2/public\footer_nav.html";i:1512439863;s:43:"./template/mobile/new2/public\wx_share.html";i:1512439863;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="banner ban1">
        <div class="mslide" id="slideTpshop">
            <ul>
                <!--广告表-->
                <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
...
foreach($result as $key=>$v):       
    ...
    <div class="floor dh">
        <nav>
            <a href="<?php echo U('Mobile/Goods/goodslist',array('id'=> 1)); ?>">
                <span>
                    <img src="__STATIC__/images/hu.png" alt="护" /><br />
                    <span>护</span>
                </span>
            </a>
            <a href="<?php echo U('Mobile/Goods/goodslist',array('id'=> 2)); ?>">
                <span>
                    <img src="__STATIC__/images/yang.png" alt="养" /><br />
                    <span>养</span>
                </span>
            </a>
            <a href="<?php echo U('Mobile/Goods/goodslist',array('id'=> 3)); ?>">
                <span>
                    <img src="__STATIC__/images/tiao.png" alt="调" /><br />
                    <span>调</span>
                </span>
            </a>
            ...
            <a href="<?php echo U('Mobile/Goods/goodslist', array('id' => 7)); ?>">
                <span>
                    <img src="__STATIC__/images/icon_07.png" alt="体验专区" /><br />
                    <span>体验专区</span>
                </span>
            </a>
            <a href="<?php echo U('Mobile/Activity/coupon_list'); ?>">
                <span>
                    <img src="__STATIC__/images/quan.png" alt="领券" /><br />
                    <span>领券</span>
                </span>
            </a>
            <!--<a href="shopcar.html">-->
            ...
            <!--<a href="my.html">-->
            <?php if(($level_id == 8) || ($level_id == 9)): if(($level_id == 8)): ?>
                    <a href="<?php echo U('Partner/index'); ?>">
                <?php endif; if(($level_id == 9)): ?>
                    <a href="<?php echo U('Store/index'); ?>">
                <?php endif; ?>
                    <span>
                        <img src="__STATIC__/images/guanli.png" alt="管理中心" /><br />
                        <span>管理中心</span>
                    </span>
                </a>
            <?php else: ?>
   ...
   <!-- <div class="floor secondkill">
    ...
    <div class="banner ma-to-20">
        <?php $pid =400;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
    ...
    <div class="floor advertisement">
        <div class="content">
            <div class="le lefhe fl">
                <?php $pid =301;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
                ...
                <?php endforeach; $pid =302;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
            ...
            <div class="le re fr">
                <?php $pid =300;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    <!--<div class="floor newshop">
        ...
        <div class="advertisement">
            <div class="content">
                <div class="le re fl">
                    <?php $pid =303;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
                ...
                <div class="le lefhe fr">
                    <?php $pid =304;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
    ...
    <!--<div class="floor hotshop index_hot">
        ...
        <div class="hotsome">
            <div class="bloc hottop">
                <?php $pid =305;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
                ...
                <?php endforeach; $pid =306;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
            ...
            <div class="bloc">
                <div class="le foura">
                    <?php $pid =307;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1520233200 and end_time > 1520233200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("4")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    <div class="flool1">
        <ul>
            <?php if(isset($_COOKIE['user_id'])): if($_COOKIE['user_id'] == 0): ?>
                    <li><a href="<?php echo U('Mobile/User/index'); ?>"><?php echo $_COOKIE['uname']; ?></a></li>
                <?php else: ?>
    ...
    <div class="flool3">
        <p>Copyright © <?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'肽风尚商城'); ?> 版权所有</p>
    </div>
</footer>
    <!--底部-end-->
