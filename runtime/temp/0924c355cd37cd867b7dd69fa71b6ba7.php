<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"./template/pc/tfs/activity\coupon_list.html";i:1519984571;s:34:"./template/pc/tfs/user\header.html";i:1512197568;s:32:"./template/pc/tfs/user\menu.html";i:1519984571;s:36:"./template/pc/tfs/public\footer.html";i:1519984596;s:42:"./template/pc/tfs/public\sidebar_cart.html";i:1519984596;}*/ ?>
<html>
<head>
<meta charset="utf-8">
<title>领券中心</title>
	...
	<?php endif; ?>
            ...
            <div class="col-md-10 col-sm-9 col-lg-10 get_coupons_r">
                ...
                <div class="get_coupons_con">
                    <ul class="get_cou_t">
                        <li><a href="<?php echo U('Activity/coupon_list'); ?>"><span>全部优惠券</span></a></li>
                        <li><a href="<?php echo U('Activity/coupon_list',array('atype'=>'4')); ?>">未开始</a></li>
                        <li><a href="<?php echo U('Activity/coupon_list',array('atype'=>'5')); ?>">可领取</a></li>
                        <li><a href="<?php echo U('Activity/coupon_list',array('atype'=>'6')); ?>">已过期</a></li>
                    </ul>
                    <div class="coupons_l_m">
                        ...
                        <?php endif; if(is_array($coupon_list) || $coupon_list instanceof \think\Collection || $coupon_list instanceof \think\Paginator): if( count($coupon_list)==0 ) : echo "" ;else: foreach($coupon_list as $key=>$vo): ?>
                        <ul class="coupons_l_goods1">
                            <li class="coupon_goods_img"><div class="coupons_img_p"><div class="coupons_img_b"><div class="coupons_bor_l"><h5><?php echo getInt($vo['money']); ?></h5></div><div class="coupons_bor_r"><h5>优惠券</h5><h6>满<?php echo getInt($vo['condition']); ?>使用</h6></div><div class="coupons_b_post"><p>￥</p></div></div></div></li>
                            <li><?php echo $vo['money']; ?></li>
                            <li>满<?php echo $vo['condition']; ?>元可用</li>
                            <li><span><?php echo date('Y-m-d H:i',$vo['send_end_time']); ?></span></li>
                            <?php if((time() > $vo['send_start_time']) AND (time() < $vo['send_end_time'])): ?>
                                <li class="get_c_i"><a href="<?php echo U('Activity/get_coupon',array('coupon_id'=>$vo[id])); ?>">领  取</a></li>
                            <?php elseif(time() > $vo['send_end_time']): ?>
                                <li class="noget_c_i"><a href="javascript:void">已过期</a></li>
                            <?php elseif(time() < $vo['send_start_time']): ?>
