<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/partner\order_list.html";i:1512439866;s:38:"./template/pc/rainbow/user\header.html";i:1512439865;s:36:"./template/pc/rainbow/user\menu.html";i:1512439865;s:46:"./template/pc/rainbow/public\footer_index.html";i:1512439865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<style>
.returnmagament .book_content ul li {padding: 10px 0}
.returnmagament .empty {padding: 20px 0; font-size: 16px; font-weight: bold; text-align: center;}
</style>
</head>
			...
			<div class="ri-menu fr">
				<div class="menumain p">
					<div class="goodpiece">
						...
						<div class="fr ddd-h2">
							<h3>
								<span style="font-size: 14px;">收益总金额：<?php if($income == null): ?>暂无<?php else: ?><?php echo $income; ?>元<?php endif; ?></span>
							</h3>
						 </div>
					</div>
					<div class="orderbook-list returnmagament">
						<div class="returngoods">
							<div class="book-tit">
								<ul>
									<li class="sx3">工厂店名称</li>
									<li class="sx1">订单号</li>
									<li class="sx2">订单金额</li>
									<li class="sx2">收益金额</li>
									<li class="sx1">下单时间</li>
									<li class="sx5">操作</li>
								</ul>
							</div>
							<?php if(!empty($orderList)): ?>
								<div class="book-tit book_content p">
									<?php if(is_array($orderList) || $orderList instanceof \think\Collection || $orderList instanceof \think\Paginator): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
										<ul>
											<li class="sx3"><?php echo $vo['store_name']; ?></li>
											<li class="sx1"><?php echo $vo['order_sn']; ?></li>
											<li class="sx2"><?php echo $vo['total_amount']; ?></li>
											<li class="sx2"><?php echo $vo['money']; ?></li>
											<li class="sx1"><?php echo date('Y-m-d H:i:s',$vo['add_time']); ?></li>
											<li class="sx5">
												<a href="<?php echo U('Partner/orderInfo', array('id'=>$vo['order_id'])); ?>">查看详情</a>
											</li>
										</ul>
