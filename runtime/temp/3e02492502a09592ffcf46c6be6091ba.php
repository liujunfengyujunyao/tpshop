<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/promotion\group_buy_list.html";i:1512439957;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<a href="<?php echo U('Promotion/group_buy'); ?>">
					<div class="fbutton">
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo $vo['start_time']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo $vo['end_time']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue" target="_blank" href="<?php echo U('Home/Activity/group',array('id'=>$vo['goods_id'])); ?>"><i class="fa fa-search"></i>查看</a>
									<a class="btn blue" href="<?php echo U('Promotion/group_buy',array('act'=>'edit','id'=>$vo['id'])); ?>"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<a class="btn red" href="javascript:void(0)" data-url="<?php echo U('Promotion/groupbuyHandle'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
