...
<head>
    ...
    <link rel="stylesheet" href="__STATIC__/css/tpshop.css" type="text/css">
                ...
                <div class="sum_main">
                    <?php
                        ...
                        <dl class="foot-con">
                            ...
                            <dd>
                                <?php if($v2['link']): ?>
                                    <a href="<?php echo $v2['link']; ?>" target="_blank"><?php echo $v2[title]; ?></a>
                                <?php else: ?>
                                <a href="<?php echo U('Home/Article/detail',array('article_id'=>$v2[article_id])); ?>"><?php echo $v2[title]; ?></a>
                                <?php endif; ?> -->
            ...
            <ul>
                ...
                <li class="re_wechat">
                    ...
                    <div class="rtipscont" style="">
                        ...
                        <img src="__STATIC__/images/qrcode1.jpg" />
