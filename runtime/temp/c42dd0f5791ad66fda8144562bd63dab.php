<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./template/pc/tfs/user\pop_login.html";i:1509018229;}*/ ?>
<!DOCTYPE HTML>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="u-qq">
    ...
    <a href="<?php echo U('LoginApi/login',array('oauth'=>'qq')); ?>"  class="qq" title="QQ"></a>
    <a href="<?php echo U('LoginApi/login',array('oauth'=>'alipay')); ?>"  class="pay" title="支付宝"></a>
    <a href="<?php echo U('LoginApi/login',array('oauth'=>'weixin')); ?>" class="weixin" title="weixin"></a>
</div>
</div>
</body>
<script>	
