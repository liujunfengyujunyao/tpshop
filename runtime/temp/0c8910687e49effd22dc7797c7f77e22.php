<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/order\delivery_list.html";i:1512439955;s:44:"./application/admin/view2/public\layout.html";i:1519984569;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0" style="width:100%;">
					<thead>
						<tr>
								...
								<th align="center" abbr="store" axis="col6" class="">
									<div style="text-align: center; width: 120px;" class="">负责工厂店</div>
								</th>
								<th align="center" abbr="article_time" axis="col6" class="">
