...
*/ 
    ...
    'WAITRECEIVE'=>' AND shipping_status=1 AND order_status in(1,6)', //订单查询状态 待收货
    ...
    'STORECONFIRM'=> 'AND order_status = 6 ',//工厂店确认收货
    ...
    //短信使用场景
    'SEND_SCENE' => array(
        '1'=>array('用户注册','您的验证码为：${code}，该验证码5分钟之内有效，请勿泄露给别人。','regis_sms_enable'),
