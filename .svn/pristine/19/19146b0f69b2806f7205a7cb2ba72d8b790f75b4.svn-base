...
function adminLog($log_info){
    ...
    //增加日志控制器名字,用以筛选    @author: Ly @date: 2017-7-29
    $add['controller'] = strtolower(request()->controller());
...
function getAllMenu(){
	return	array(
            ...
            //增加风尚美人柜相关菜单,方便权限过滤    @author:    Ly      @date:  2017-7-15
            'sark' => array('name' => '风尚美人柜管理', 'icon' => 'fa-anchor', 'sub_menu' => array(
                    array('name' => '风尚美人柜列表', 'act' => 'index', 'control'=> 'Sark'),
                    array('name' => '添加风尚美人柜', 'act' => 'add', 'control' => 'Sark')
            )),
            //添加合伙人管理相关菜单 @author Dh @date 2017-07-29
			'partner' => array('name' => '合伙人管理', 'icon' => 'fa-anchor', 'sub_menu' => array(
					array('name' => '合伙人列表', 'act' => 'index', 'controller' => 'Partner'),
					array('name' => '添加合伙人', 'act' => 'add', 'controller' => 'Partner'),
					array('name' => '提现申请记录', 'act' => 'withdrawals', 'controller' => 'Partner'),
					array('name' => '汇款记录', 'act' => 'remittance', 'controller' => 'Partner'),
					array('name' => '库存管理', 'act' => 'stockList', 'controller' => 'Partner'),
					array('name' => '库存日志', 'act' => 'stockLog', 'controller' => 'Partner'),
					array('name' => '订单列表', 'act' => 'orderList', 'controller' => 'Partner'),
					array('name' => '订单详情', 'act' => 'order_info', 'controller' => 'Partner'),
					array('name' => '配货单列表', 'act' => 'invoice', 'controller' => 'Partner'),
					array('name' => '配货单详情', 'act' => 'invoice_info', 'controller' => 'Partner'),
            ...
            'store' => array('name' => '工厂店管理', 'icon'=> 'fa-anchor', 'sub_menu' =>array(
                ...
                array('name' => '库存日志', 'act' => 'stocklog', 'controller' => 'Store'),
                array('name' => '订单列表', 'act' => 'orderList', 'controller' => 'Store')
