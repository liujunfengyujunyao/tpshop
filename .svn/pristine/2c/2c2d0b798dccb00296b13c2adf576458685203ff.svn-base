...
function get_city(t){
    var parent_id = $(t).val();
    if(parent_id == 0){
        $('#city').empty().css('display','inline').html("<option value=''>选择城市</option>");
        $('#district').empty().css('display','inline').html("<option value=''>选择区域</option>");
        return;
    }
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?06e9734f33e7ff39eccc218a7043f30f";
